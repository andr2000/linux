/*
 * Remote processors emulator driver for GX6XXX GPUs
 *
 * Copyright (C) 2017 EPAM Systems Inc.
 * Author: Oleksandr Andrushchenko <oleksandr_andrushchenko@epam.com>
 * based on drivers/misc/coproc_emulators/coproc-emu.c
...
#define DEBUG 1
#define pr_fmt(fmt) "coproc-emu-gx6xxx: %s: " fmt, __func__
...
static void coproc_emu_device_start_scheduler(
...
static int coproc_emu_device_dt_probe(struct platform_device *pdev)
{
	...
	coproc_emu_device_start_scheduler(coproc_emu);
...
MODULE_DESCRIPTION("Remote processors emulator driver for GX6XXX GPUs");
