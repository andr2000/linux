...
EXPORT_SYMBOL(xen_mem_reservation_scrub_page);
...
EXPORT_SYMBOL(xen_mem_reservation_va_mapping_update);
...
EXPORT_SYMBOL(xen_mem_reservation_va_mapping_reset);
...
EXPORT_SYMBOL(xen_mem_reservation_increase);
...
EXPORT_SYMBOL(xen_mem_reservation_decrease);
