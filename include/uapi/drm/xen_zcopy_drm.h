 ...
 * by the frontend:
 *  o Frontend
 *    o creates a dumb/display buffer and allocates memory.
 *    o grants foreign access to the buffer pages
 ...
 * backend:
 *  o Frontend
 *    o requests backend to allocate dumb/display buffer and grant references
 *      to its pages
 *  o Backend
 ...
 *   o passes grant references to the frontend
 *   o at the end:
 *     o closes zero-copy driver's handle with DRM_IOCTL_GEM_CLOSE
 *     o closes real HW driver's handle with DRM_IOCTL_GEM_CLOSE
