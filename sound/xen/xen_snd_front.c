...
static int be_query_hw_param(struct xen_snd_front_evtchnl *evtchnl,
...
static int be_stream_prepare(struct xen_snd_front_evtchnl *evtchnl,
...
static int be_stream_close(struct xen_snd_front_evtchnl *evtchnl)
{
	struct xen_snd_front_info *front_info = evtchnl->front_info;
	struct xensnd_req *req;
	unsigned long flags;
...
static int be_stream_write(struct xen_snd_front_evtchnl *evtchnl,
...
static int be_stream_read(struct xen_snd_front_evtchnl *evtchnl,
		unsigned long pos, unsigned long count)
{
	struct xen_snd_front_info *front_info = evtchnl->front_info;
	struct xensnd_req *req;
...
static int be_stream_trigger(struct xen_snd_front_evtchnl *evtchnl, int type)
{
	struct xen_snd_front_info *front_info = evtchnl->front_info;
	struct xensnd_req *req;
	unsigned long flags;
...
static struct xen_snd_front_ops front_ops = {
	.query_hw_param = be_query_hw_param,
	.prepare = be_stream_prepare,
	.close = be_stream_close,
	.write = be_stream_write,
	.read = be_stream_read,
	.trigger = be_stream_trigger,
	/* .handle_cur_pos callback will be set by ALSA code */
};
		...
		const struct xenbus_device_id *id)
{
	...
	front_info->front_ops = &front_ops;
